...
constexpr uint32_t RA_TIME_TO_BURNOUT_MIN = 1.7 * 1000ul;  // ms

// Safeguard maximum time to motor burnout
constexpr uint32_t RA_TIME_TO_BURNOUT_MAX = 2.1 * 1000ul;  // ms

// Safeguard minimum time to apogee - drogue deployment
constexpr uint32_t RA_TIME_TO_APOGEE_MIN = 14 * 1000ul;  // ms
...
constexpr double RA_APOGEE_ALT = 1250.0;  // m
...
constexpr double RA_MAIN_ALT_RAW = 100.0;  // m
